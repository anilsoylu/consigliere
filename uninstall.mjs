...
import { STATE_FILE, HOOK_FILES, OBSOLETE_HOOK_FILES, OBSOLETE_AGENT_FILES, OBSOLETE_RULE_FILES, AGENT_FILES, DEFAULT_RULES, WORKFLOW_RULE, HANDOFF_SKILLS, HANDOFF_FILES, GRILLING_SKILLS, GRILLING_FILES, OPTIMIZE_SKILLS, OPTIMIZE_FILES, MERGE_READINESS_SKILL, MERGE_READINESS_FILES, UPGRADE_SKILL, UPGRADE_FILES, YAGNI_SKILL, YAGNI_FILES, IMPLEMENT_SKILL, IMPLEMENT_FILES, REVIEW_SKILL, REVIEW_FILES, WIZARD_SKILL, WIZARD_FILES, ALMOST_PAID_SKILL, ALMOST_PAID_FILES, DEBUGGING_SKILL, DEBUGGING_FILES, SHADCN_SKILL, SHADCN_FILES, claudeDir } from './manifest.mjs';
...
removeUntouched(IMPLEMENT_FILES, path.join(REPO, 'skills', IMPLEMENT_SKILL), path.join(SKILLS, IMPLEMENT_SKILL), { prune: true });
removeUntouched(REVIEW_FILES, path.join(REPO, 'skills', REVIEW_SKILL), path.join(SKILLS, REVIEW_SKILL), { prune: true });
removeUntouched(WIZARD_FILES, path.join(REPO, 'skills', WIZARD_SKILL), path.join(SKILLS, WIZARD_SKILL), { prune: true });
removeUntouched(ALMOST_PAID_FILES, path.join(REPO, 'skills', ALMOST_PAID_SKILL), path.join(SKILLS, ALMOST_PAID_SKILL), { prune: true });
