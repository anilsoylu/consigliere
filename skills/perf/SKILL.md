...
description: >-
  ...
  or optimization work. A known routine that needs an exact-parity speed
  rewrite goes to /optimize instead.
---
...
5. `clean` first, then ship in topical commits (`pr-update`); keep CI green.
